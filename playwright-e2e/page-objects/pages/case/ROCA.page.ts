...
class ROCAPage extends Base {
  ...
  constructor(page) {
    ...
    this.defARestrDocRoca = page.getByText(
      "Name: restrictedSectionUploadDefendantOne",
      { exact: true },
    );
    this.defBRestrDocRoca = page.getByText(
      "Name: restrictedSectionUploadDefendantTwo",
      { exact: true },
    );
  }
